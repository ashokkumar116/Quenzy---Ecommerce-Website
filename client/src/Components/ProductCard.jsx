...
const ProductCard = ({ product, isInCart ,offerPrice }) => {
    ...
    return (
                        <div
                            className="border border-primary/50 rounded-md md:px-4 px-3 py-2 bg-base-100 min-w-66 max-w-86 w-full hover:scale-101 transition duration-200 ease-in-out "
                        >
                            <div
                            ...
                            >
                                <img
                                    className="group-hover:scale-105 transition max-w-26 md:max-w-46 h-40 mb-3"
                                    src={`${asset.imageBaseUrl}${product.images[0]?.image_url}`}
                                    alt={product.name}
                                />
                            </div>
