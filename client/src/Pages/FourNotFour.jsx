...
const FourNotFour = () => {
  return (
    ...
    <p class="text-sm md:text-base mt-4 text- max-w-md text-center">The page you are looking for might have been removed, had its name changed, or is temporarily unavailable.</p>
