...
const FourNotFour = () => {
  return (
    ...
    <div class="flex items-center gap-4 mt-6">
        <a href="/" class="btn btn-primary px-7 py-2.5 rounded-md active:scale-95 transition-all">
            Return Home
        </a>
        <a href="#" class="px-7 py-2.5 btn btn-primary btn-outline rounded-md active:scale-95 transition-all">
            Contact support
        </a>
    </div>
</div>
