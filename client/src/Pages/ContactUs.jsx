...
const ContactUs = () => {
    ...
    return (
        <div className="py-30 bg-base-300 flex flex-col items-center">
            <form className="flex flex-col items-center text-sm bg-base-100 w-250 p-6 rounded-lg shadow-lg" onSubmit={handleMail}>
            ...
            <p className="text-sm text-base-content/60 text-center pb-10 w-150">We’re always here to help! Whether you have questions about your order, need help choosing the right product, or just want to say hello — don’t hesitate to reach out.</p>
